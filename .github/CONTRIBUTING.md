...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `this project` as smooth as possible.
...
As a user of `this project`, you're the perfect candidate to help us improve our documentation!
...
The [`question`]() labels are a good place to find ongoing discussions.
...
After [cloning the repository](https://help.github.com/articles/cloning-a-repository/), run `yarn` or `npm` to install dependencies.

A summary of the scripts:

[PUT THE SCRIPTS THAT MAKE SENSE HERE]
